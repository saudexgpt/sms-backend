...
class ResultComment
{
    ...
    {
        return [
            new ResultComment( 80, 100, ["%s is an excellent student and should keep up the momentum.", "%s is an enthusiastic learner who settles for nothing below excellence.",
            ...
            new ResultComment( 60, 79.999, ["Impressive performance by %s. But there are more grounds to cover.",
            ...
            new ResultComment( 0, 39.999, ["A weak performance. %s needs urgent attention.", "%s should urgently be attended to concerning this performance.",
    ...
    {
        return [
            new ResultComment( 80, 100, ["Excellent performance by %s", "%s had an outstanding result",
                "%s had an excellent result", "%s's performance is exceptional", ] ),

            new ResultComment( 60, 79.999, ["A very good result by %s", "%s's performance is very impressive",
            ...
            new ResultComment( 0, 39.999, ["%s did well below average", "%s has a poor result",
                "%s did poorly" ] ) 
        ];
    }
