        ...
        <div class="vx-row">
          <div class="vx-col w-full">
            <div class="flex items-end px-3">
              <feather-icon svg-classes="w-6 h-6" icon="LockIcon" class="mr-2" />
          ...
          <table class="w-full permissions-table">
            <tr>
              <!--
               ...
               -->
              <th v-for="heading in ['Module', 'Read', 'Write', 'Create', 'Delete']" :key="heading" class="font-semibold text-base text-left px-3 py-2">{{ heading }}</th>
            </tr>

            <tr v-for="(val, name) in user_data.permissions" :key="name">
              <td class="px-3 py-2">{{ name }}</td>
              <td v-for="(permission, name) in val" :key="name+permission" class="px-3 py-2">
