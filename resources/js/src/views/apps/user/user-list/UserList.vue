...
<template>
  ...
  <div id="page-user-list">
    ...
    <vx-card ref="filterCard" title="Filters" class="user-list-filters mb-8" action-buttons @refresh="resetColFilters" @remove="resetColFilters">
      <div class="vx-row">
    ...
    <div class="vx-card p-6">
      ...
      <div class="flex flex-wrap items-center">
        ...
        <vs-input v-model="searchQuery" class="sm:mr-4 mr-0 sm:w-auto w-full sm:order-normal order-3 sm:mt-0 mt-4" placeholder="Search..." @input="updateSearchQuery" />
          ...
          <vs-dropdown-menu>
            ...
            <vs-dropdown-item>
              <span class="flex items-center">
                <feather-icon icon="TrashIcon" svg-classes="h-4 w-4" class="mr-2" />
                <span>Delete</span>
              </span>
            </vs-dropdown-item>
            ...
            <vs-dropdown-item>
              <span class="flex items-center">
                <feather-icon icon="ArchiveIcon" svg-classes="h-4 w-4" class="mr-2" />
                <span>Archive</span>
              </span>
            </vs-dropdown-item>
            ...
            <vs-dropdown-item>
              <span class="flex items-center">
                <feather-icon icon="FileIcon" svg-classes="h-4 w-4" class="mr-2" />
                <span>Print</span>
              </span>
            </vs-dropdown-item>
            ...
            <vs-dropdown-item>
              <span class="flex items-center">
                <feather-icon icon="SaveIcon" svg-classes="h-4 w-4" class="mr-2" />
                <span>CSV</span>
              </span>
            </vs-dropdown-item>
