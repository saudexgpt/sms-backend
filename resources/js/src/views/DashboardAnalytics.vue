  ...
  <div id="dashboard-analytics">
    <div class="vx-row">
      ...
      <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
        <statistics-card-line :chart-data="subscribersGained.series" icon="UsersIcon" statistic="92.6k" statistic-title="Subscribers Gained" type="area"/>
      </div>

      <!-- CARD 3: ORDER RECIEVED -->
      <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
        <statistics-card-line :chart-data="ordersRecevied.series" icon="ShoppingBagIcon" statistic="97.5K" statistic-title="Orders Received" color="warning" type="area"/>
      </div>
    </div>
      ...
      <div class="vx-col w-full md:w-1/2 mb-base">
        <vx-card>
          <div class="vx-row flex-col-reverse md:flex-col-reverse sm:flex-row lg:flex-row">
            ...
            <!-- LEFT COL -->
            <div v-if="salesBarSession.analyticsData" class="vx-col w-full md:w-full sm:w-1/2 lg:w-1/2 xl:w-1/2 flex flex-col justify-between">
              <div>
            ...
            <div class="vx-col w-full md:w-full sm:w-1/2 lg:w-1/2 xl:w-1/2 flex flex-col lg:mb-0 md:mb-base sm:mb-0 mb-base">
              ...
              <vue-apex-charts v-if="salesBarSession.series" :options="analyticsData.salesBar.chartOptions" :series="salesBarSession.series" type="bar" height="200" />
            </div>
          ...
          <div class="vx-row">
            <div class="vx-col w-1/2 mb-3">
              <p>Goal: $100000</p>
              <vs-progress :percent="50" class="block mt-1" color="primary"/>
            </div>
            <div class="vx-col w-1/2 mb-3">
              <p>Users: 100K</p>
              <vs-progress :percent="60" class="block mt-1" color="warning"/>
            </div>
            <div class="vx-col w-1/2 mb-3">
              <p>Retention: 90%</p>
              <vs-progress :percent="70" class="block mt-1" color="danger"/>
            </div>
            <div class="vx-col w-1/2 mb-3">
              <p>Duration: 1yr</p>
              <vs-progress :percent="90" class="block mt-1" color="success"/>
            </div>
          </div>
        </vx-card>
      </div>
          ...
          <div v-if="supportTracker.analyticsData" slot="no-body">
            <div class="vx-row text-center">
              ...
              <div class="vx-col w-full lg:w-4/5 md:w-full sm:w-4/5 justify-center mx-auto lg:mt-0 md:mt-6 sm:mt-0 mt-6">
                <vue-apex-charts :options="analyticsData.supportTrackerRadialBar.chartOptions" :series="supportTracker.series" type="radialBar" height="385" />
              </div>
            </div>

            <!-- Support Tracker Meta Data -->
            <div class="flex flex-row justify-between px-8 pb-4 mt-4">
              <p v-for="(val, key) in supportTracker.analyticsData.meta" :key="key" class="text-center">
...
const getUser = new Resource('auth/user');
export default {
  components: {
    VueApexCharts,
    StatisticsCardLine,
