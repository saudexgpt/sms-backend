        ...
        <div class="router-view">
          <div class="router-content">
              ...
              <div v-if="$route.meta.breadcrumb || $route.meta.pageTitle" class="router-header flex flex-wrap items-center mb-6">
                ...
                <vs-dropdown vs-trigger-click class="ml-auto md:block hidden cursor-pointer">
                  ...
                  <vs-dropdown-menu class="w-32">
                    <vs-dropdown-item>
                      <div class="flex items-center" @click="$router.push('/pages/profile').catch(() => {})">
                        <feather-icon icon="UserIcon" class="inline-block mr-2" svg-classes="w-4 h-4" />
                        <span>Profile</span>
                      </div>
                    </vs-dropdown-item>
                    <vs-dropdown-item>
                      <div class="flex items-center" @click="$router.push('/apps/todo').catch(() => {})">
                        <feather-icon icon="CheckSquareIcon" class="inline-block mr-2" svg-classes="w-4 h-4" />
                        <span>Tasks</span>
                      </div>
                    </vs-dropdown-item>
                    <vs-dropdown-item>
                      <div class="flex items-center" @click="$router.push('/apps/email').catch(() => {})">
            ...
            <div class="content-area__content">
              ...
              <back-to-top v-if="!hideScrollToTop" :right="$vs.rtl ? 'calc(100% - 2.2rem - 38px)' : '30px'" bottom="5%" visibleoffset="500">
