...
export default {
  en: {
    ...
    AwardOperations: 'Award Operations',
    ManageOrders: 'Manage Orders',
    AccountOperations: 'Account Operations',
    DeductUsersMoney: 'Deduct Users Money',
    CalcualteUsersTotal: 'Calcualte Users Total',
    FinancialRecords: 'Financial Records',
    Payouts: 'Payouts',
    GoodsCollections: 'Goods Collections',
    AuditTrail: 'Audit Trail',
    MLMSettings: 'MLM Settings',
    GeneralSettings: 'General Settings',
    Reports: 'Reports',
    ViewReports: 'View Reports',
    FoodCollections: 'Food Collections',
    FoodPortal: 'Food Portal',
